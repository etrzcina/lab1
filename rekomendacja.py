...
print("Nazywam si� Estera Trzcina. M�j login GitHub to etrzcina. Moja praca magisterska b�dzie dotyczy� tomografii GNSS troposfery.")
print("Skrypt rekomendacja.py wyszukuje u�ytkownik�w pasuj�cych do siebie pod wzgl�dem gust�w muzycznych. Podpowiada potencjalnie interesuj�cych artyst�w.")
